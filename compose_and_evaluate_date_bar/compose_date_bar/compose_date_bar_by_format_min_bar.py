...
logging.basicConfig(
    file_name='compose_date_bar_by_format_min_bar.log',
    level=logging.INFO,
...
def main():
    ...
    DATE_BAR_FOLDER_PATH = config.date_bar_develop_hist_folder_path['v10']
    num_process = 10
